...
function SMODS.INIT.MystJokers()
    ...
    for _, v in ipairs(joker_list) do
        ...
        elseif joker.fusion and not SMODS.INIT.FusionJokers then
            ...
            SMODS.Joker:new(joker.name, 'myst_'..joker.slug, joker.config, {x = 0, y = 0}, joker.localization, joker.rarity, joker.cost, true, false, joker.blueprint_compat, joker.eternal_compat, "", "j_"..joker.slug):register()
